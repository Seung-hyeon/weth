...
// that address/topic, and binary AND-ing those vectors towether.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them towether
				var orVector []byte
...
// the reuested retrieval queue to be serviced towether with other sessions.
//
