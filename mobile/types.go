...
func (tx *Transaction) GetFrom(atfieldID *BigInt) (address *Address, _ error) {
	var signer types.Signer = types.HomesteadSigner{}
	if atfieldID != nil {
		signer = types.NewATFieldSigner(atfieldID.bigint)
	}
...
func (tx *Transaction) WithSignature(sig []byte, atfieldID *BigInt) (signedTx *Transaction, _ error) {
	var signer types.Signer = types.HomesteadSigner{}
	if atfieldID != nil {
		signer = types.NewATFieldSigner(atfieldID.bigint)
	}
