...
# 1. install weth for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for weth
# 5. create weth, attach and uninstall start menu entries
...
function .onInit
  # make vars are global for all users since weth is installed global
