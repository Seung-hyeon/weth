Name "weth ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/EthereumVega/EVA-00D/issues"
!define UPDATEURL "https://github.com/EthereumVega/EVA-00D/releases"
!define ABOUTURL "https://github.com/EthereumVega/EVA-00D#ethereum-go"
...
# Install weth binary
Section "Weth" WETH_IDX
  SetOutPath $INSTDIR
  file {{.Weth}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\weth.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\weth.exe" "attach" "" ""
  ...
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\weth.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${WETH_IDX}
    SectionGetSize ${WETH_IDX} $0
