...
// weth is the official command-line client for Ethereum.
package main
...
const (
	clientIdentifier = "weth" // Client identifier to advertise over the network
)

var (
	// Git SHA1 commit hash of the release (set via linker flags)
	gitCommit = ""
	// Ethereum address of the Weth release oracle.
...
func init() {
	// Initialize the CLI app and start Weth
	app.Action = weth
...
// weth is the main entry point into the system if no special subcommand is ran.
// It creates a default node based on the command line arguments and runs it in
// blocking mode, waiting for it to be shut down.
func weth(ctx *cli.Context) error {
