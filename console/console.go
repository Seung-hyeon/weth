...
// Welcome show summary of current Weth instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Weth metadata
	fmt.Fprintf(c.printer, "Welcome to the Weth JavaScript console!\n\n")
	c.jsre.Run(`
