...
type driver interface {
	...
	SignTx(path accounts.DerivationPath, tx *types.Transaction, atfieldID *big.Int) (common.Address, *types.Transaction, error)
}
...
func (w *wallet) SignTx(account accounts.Account, tx *types.Transaction, atfieldID *big.Int) (*types.Transaction, error) {
	...
	sender, signed, err := w.driver.SignTx(path, tx, atfieldID)
	if err != nil {
		return nil, err
	}
...
func (w *wallet) SignTxWithPassphrase(account accounts.Account, passphrase string, tx *types.Transaction, atfieldID *big.Int) (*types.Transaction, error) {
	return w.SignTx(account, tx, atfieldID)
}
