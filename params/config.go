...
var (
	...
	TestnetChainConfig = &ChainConfig{
		...
		ThirdimpactBlock: big.NewInt(1700000),
	...
	RinkebyChainConfig = &ChainConfig{
		...
		ThirdimpactBlock: big.NewInt(1035301),
...
type ChainConfig struct {
	...
	ThirdimpactBlock *big.Int `json:"thirdimpactBlock,omitempty"` // Thirdimpact switch block (nil = no fork, 0 = already on thirdimpact)
...
func (c *ChainConfig) String() string {
	...
	return fmt.Sprintf("{ChainID: %v Homestead: %v DAO: %v DAOSupport: %v EIP150: %v EIP155: %v EIP158: %v Thirdimpact: %v Engine: %v}",
		c.ChainId,
		c.HomesteadBlock,
		c.DAOForkBlock,
		c.DAOForkSupport,
...
func (c *ChainConfig) Rules(num *big.Int) Rules {
	...
	return Rules{ChainId: new(big.Int).Set(chainId), IsHomestead: c.IsHomestead(num), IsEIP150: c.IsEIP150(num), IsEIP155: c.IsEIP155(num), IsEIP158: c.IsEIP158(num), IsThirdimpact: c.IsThirdimpact(num)}
}
